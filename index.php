  ...
  <main>
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-6 px-0 d-none d-sm-block" id="block-img">
          <img src="icon/Logo-Institut-Pasteur-Dakar-1024x724.png" alt="login image" class="login-img" id="login-img">
        </div>
      </div>
    </div>
  </main>
