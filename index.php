...
<body>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div style="margin-right: 3%;" class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            <li id="vs"><a class="dropdown-item" href="#">vue satellite</a></li>
                            <li id="vn"><a class="dropdown-item" href="#">vue normale</a></li>
                            <li id="vt"><a class="dropdown-item" href="#">vue terrain</a></li>
                        </ul>
                    </div>
    ...
    <script>
        ...
        let link = 'https://api.mapbox.com/styles/v1/frouty/ckttyl6rv0sfm18lp2ik0tlu8/tiles/256/{z}/{x}/{y}@2x?access_token=pk.eyJ1IjoiZnJvdXR5IiwiYSI6ImNrdHR5NGZrZDF1eWIybm1wbHE1anEwMmkifQ.hdvcG_84hG2O8fUo3hcd8w';
        ...
        document.getElementById("vt").addEventListener("click", function() {
            changeBackgroundTo('https://api.mapbox.com/styles/v1/frouty/ckttzhsqr0tlw17kf5280e50h/tiles/256/{z}/{x}/{y}@2x?access_token=pk.eyJ1IjoiZnJvdXR5IiwiYSI6ImNrdHR5NGZrZDF1eWIybm1wbHE1anEwMmkifQ.hdvcG_84hG2O8fUo3hcd8w');
        });
        document.getElementById("vn").addEventListener("click", function() {
            changeBackgroundTo('https://api.mapbox.com/styles/v1/frouty/ckttyl6rv0sfm18lp2ik0tlu8/tiles/256/{z}/{x}/{y}@2x?access_token=pk.eyJ1IjoiZnJvdXR5IiwiYSI6ImNrdHR5NGZrZDF1eWIybm1wbHE1anEwMmkifQ.hdvcG_84hG2O8fUo3hcd8w');
        });
